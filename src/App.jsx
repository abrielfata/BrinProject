  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section id="research" className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Research Overview</h2>
            <p className="text-gray-600">Section penelitian akan dibuat di step selanjutnya</p>
          </div>
        </section>

        {/* Sentiment Analyzer Section dengan styling minimalis putih */}
